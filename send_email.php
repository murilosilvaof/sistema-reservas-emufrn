...
$assunto = "=?UTF-8?Q?" . quoted_printable_encode("NOVA SOLICITACAO DE RESERVA - $sala") . "?=";
    ...
    <body>
      <div class='container'>
        ...
        <h1>NOVA SOLICITACAO DE RESERVA</h1>

        <p><strong>Nome:</strong> $nome</p>
        <p><strong>Instrumento:</strong> $_POST[instrumento]</p>
        <p><strong>Matrícula:</strong> $matricula</p>
        <p><strong>Email:</strong> <a href='mailto:$email'>$email</a></p>
        <p><strong>Espaço:</strong> $sala</p>
        <p><strong>Tipo de Evento:</strong> $_POST[tipo_evento]</p>
        <p><strong>Perfil:</strong> $_POST[perfil]</p>
        <p><strong>Dia:</strong> $dia</p>
        <p><strong>Horário:</strong> $horario ($periodo)</p>
        <p><strong>Observações:</strong> $obs</p>

        <div class='botoes'>
          <a href='https://seudominio.com/resposta.php?id=$reservaId&status=confirmado' class='confirmar'>✔ Confirmar Reserva</a>
          <a href='https://seudominio.com/resposta.php?id=$reservaId&status=negado' class='negar'>✖ Recusar Reserva</a>
        </div>
      </div>
    </body>
    </html>
